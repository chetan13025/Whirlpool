...
public class Create_trip extends File_upload {
	...
	public static void Trip() throws InterruptedException {
		...
		driver.findElement(By.xpath(Log_field)).sendKeys("Chetan_par");
		driver.findElement(By.xpath(Par)).click();
		driver.findElement(By.xpath(Log_ex)).sendKeys("chetanp");
		...
		driver.findElement(By.xpath(Executive)).sendKeys("Chetanp");
		driver.findElement(By.xpath(Exe)).click();
		driver.findElement(By.xpath(Asexe)).sendKeys("Chetanp");
		driver.findElement(By.xpath(Exe)).click();
